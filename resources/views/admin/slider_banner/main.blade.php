                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('admin.slider_banner.create') }}" class="btn btn-primary">
                                        ...
                                        @foreach ($datas as $data)
                                            <tr>
                                                <td class="text-center">
                                                    <a href="{{ route('admin.slider_banner.edit', $data->id) }}"
                                                ...
                                                <td>
                                                    {!! $data->banner_desktop_img !!}
                                                </td>
                                                <td>
                                                    {!! $data->banner_mobile_img !!}
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
