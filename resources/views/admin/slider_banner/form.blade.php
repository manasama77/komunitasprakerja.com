                ...
                <div class="col-sm-12 col-md-6 offset-md-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.slider_banner.store') }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholders="Banner Name" value="{{ old('name') }}" required />
                                </div>
                                <div class="form-group">
                                    <label for="url">URL</label>
                                    <input type="text" class="form-control" id="url" name="url"
                                        placeholders="URL" value="{{ old('url') }}" required />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="file" class="form-control" id="banner_desktop" name="banner_desktop"
                                            ...
                                            onchange="showPreview('banner_desktop')" required />
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="file" class="form-control" id="banner_mobile" name="banner_mobile"
                                            accept="image/png, image/gif, image/jpeg, image/webp"
                                            onchange="showPreview('banner_mobile')" required />
                                    </div>
                                    <span class="text-muted">size: 1721 x 1801 px</span>
                                </div>
