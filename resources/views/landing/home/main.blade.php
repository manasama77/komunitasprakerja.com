...
@section('aku_isi_mas')
    <!-- ======= Hero Section ======= -->
    @include('landing.sections.beranda_slider')
    <!-- End Hero Section -->

    <main id="main">

        <!-- ======= Siapa kita Section ======= -->
        @include('landing.sections.siapa_kita')
        <!-- End Siapa kita Section -->

        <!-- ======= Panduan Section ======= -->
        @include('landing.sections.panduan')
        <!-- End Panduan Section -->

        <!-- ======= Team Tutor Section ======= -->
        @include('landing.sections.team_tutor')
        <!-- Team Tutor Section -->

        <!-- ======= Panduan Section ======= -->
        @include('landing.sections.jadwal')
        <!-- End Panduan Section -->
